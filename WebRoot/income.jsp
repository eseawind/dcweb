...
<div class="rightdh">
	<b class="dot_nav"></b><s:text name="RES_CURRENTLOCAL"/>: <a href="javascript:;" onclick="drawmenu.getBody('powerlist.action');return false;"><s:text name="RES_HOME"/></a> > <a href="#"><s:text name="RES_INCOME"/></a>
</div>
<div class="rightcon">
	<div class="rightcon_tcon">
		<div class="container">
			<div class="title"><s:text name="RES_INCOME"/> ( <s:property value="#session.defaultStationMap.stationname" /> ) </div>
			<div class="dot_con">
				<input id="t" type="hidden" value="income" />
		...
		<div class="p_rtb" style="float: left;">
			<div class="p_rttab" style="left: 10px;">
					<div class="tab" linked='income.action?type=day'>
						<s:if test="type=='day'">
					...
					<div class="tab" style="margin-left: 10px;" linked='income.action?type=month'>
					...
					<div class="tab" style="margin-left: 10px;" linked='income.action?type=year'>
						<s:if test="type=='year'" >
							<div class="tableft_on"></div>
				...
				<div id="flashCont">
					<s:property  value='#session.defaultStation'/>
						 <script type="text/javascript">
							 	...
							 	showFlashElement("swf/IncomeDay.swf",flashvars);
						 </script>
				</div>
			</div>
			</s:if>
			...
			<div style="width: 90%;height:560px;margin: 0 auto;padding-top: 20px;">
				<div id="flashCont">
						 <script type="text/javascript">
							 	//var flashvars = {"lang":"<%= lang %>","isno":"88830000000000030000","baseUrl":"<%= baseUrl %>","type":"day","date":"2012-02-03"}
							 	var flashvars = {"lang":"<%= lang %>","stationid":"<s:property  value='#session.defaultStation'/>","baseUrl":"<%= baseUrl %>","type":"day","date":"<s:property  value='sdate'/>"}
							 	showFlashElement("swf/IncomeMonth.swf",flashvars);
						 </script>
				</div>
			</div>
			</s:elseif>
			...
			<div style="width: 90%;height:560px;margin: 0 auto;padding-top: 20px;">
				<div id="flashCont">
						 <script type="text/javascript">
							 	//var flashvars = {"lang":"<%= lang %>","isno":"88830000000000030000","baseUrl":"<%= baseUrl %>","type":"day","date":"2012-02-03"}
							 	var flashvars = {"lang":"<%= lang %>","stationid":"<s:property  value='#session.defaultStation'/>","baseUrl":"<%= baseUrl %>","type":"day","date":"<s:property  value='sdate'/>"}
							 	showFlashElement("swf/IncomeYear.swf",flashvars);
						 </script>
				</div>
			</div>
			</s:elseif>
