        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1">
              ...
              <tr>
                <td width="29%" height="30" bgcolor="#c7edff" class="black2"><div align="right">subtag：</div></td>
                <td width="24%" height="30" bgcolor="#c7edff">
                <input id="language"  name="language" type="text" class="test_input8"/></td>
                <td width="25%" height="30" bgcolor="#c7edff" class="black2"><div align="right">language：</div></td>
                <td width="29%" height="30" bgcolor="#c7edff">
                <input  id="subtag" name="subtag" type="text" class="test_input8"  /></td>
              </tr>
              <tr>
                <td width="29%" height="30" bgcolor="#c7edff" class="black2"><div align="right">val1：</div></td>
                <td width="24%" height="30" bgcolor="#c7edff">
                <input  id="val1" name="val1" type="text" class="test_input8" /></td>
                <td width="25%" height="30" bgcolor="#c7edff" class="black2"><div align="right">val2：</div></td>
                <td width="29%" height="30" bgcolor="#c7edff">
                <input id="val2"  name="val2" type="text" class="test_input8"  /></td>
              </tr>
              <tr>
                <td width="29%" height="30" bgcolor="#c7edff" class="black2"><div align="right">context：</div></td>
                <td width="24%" height="30" bgcolor="#c7edff">
                <input id="context"  name="context" type="text" class="test_input8"  /></td>
