...
function loadMainMenu(id){
	var menu="mainMenu"+id;
	var menuimg="mainMenuImg"+id;
	eval(menu+".className='blue';");
	eval(menuimg+".src='images/dh_list_"+id+".gif';");
}
</script>
          ...
          <tr>
            ...
            <table  width="600"  border="0" cellpadding="0" cellspacing="0">
              ...
              <s:if test="#session.defaultStation!=0">
				...
				<td id="mainMenu1" width="150" height="34" class="blue">
				...
				<td id="mainMenu2" width="150" align="right" class="white3" onclick="changeMenusMain('chartShow.action',13)" style="cursor:pointer"> <div align="left"><strong> 
