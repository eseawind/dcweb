...
<div class="rightdh">
	<b class="dot_nav"></b><s:text name="RES_CURRENTLOCAL"/>: <a href="javascript:;" onclick="drawmenu.getBody('powerlist.action');return false;"><s:text name="RES_HOME"/></a> > <a href="javascript:;" onclick="return false;"><s:text name="RES_STATIONATTRIBUTE"/></a> 
</div>
<div class="rightcon">
	<div class="rightcon_tcon" style="line-height: 30px;">
		<div class="container">
			<div class="title"><s:text name="RES_STATIONATTRIBUTE"/> ( <s:property value="#session.defaultStationMap.stationname" /> ) <input id="text_userId" type="hidden" value="<s:property value='userMap.userId'/>" /></div>
		</div>
