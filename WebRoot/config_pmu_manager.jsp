            ...
            <td align="center"><table width="896" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table width="896" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="10">&nbsp;</td>
                      <td width="93" align="center" valign="middle" background="images/listbg25.gif" class="white3"  onclick="location.href='confPmuList.action'" style="cursor:pointer"><s:text name="RES_CONF_LIST"/></td>
                      <td width="4">&nbsp;</td>
