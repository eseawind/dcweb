create or replace procedure SP_GET_INV_VAC_7DAY(
i_stationid number,
...
begin
   ...
   commit;
   open curmain for select sv1 isno,sv2 recvdt,sv3 rtime,idd fen10,nv1 data1/*vac1*/,nv2 data2/*vac2*/,nv3 data3/*vac3*/,'V' unit,3 res_num from tmp_info order by isno,recvdt,fen10;
end SP_GET_INV_VAC_7DAY;
/
