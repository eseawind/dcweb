...
begin
  ...
  open cur_result for select decode(i_stationid,0,v_listconfig,v_stationconfig) config,
                             ...
                             decode(i_stationid,0,
                                  /*列表菜单*/decode(v_deflisturl,1,'plantmanager.action',3,'confPmuList.action',5,'confInvList.action',7,'accountManager.action',9,'accountList.action',11,'sysqueryevent.action','none'),
