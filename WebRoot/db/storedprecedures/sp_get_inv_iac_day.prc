create or replace procedure SP_GET_INV_IAC_DAY(
...
begin
   ...
   commit;
   open curmain for select sv1 isno,sv2 recvdt,sv3 rtime,idd fen10,nv1 data1/*iac1*/,nv2 data2/*iac2*/,nv3 data3/*iac3*/,'A' unit,3 res_num from tmp_info order by isno,sv1,fen10;
end SP_GET_INV_IAC_DAY;
/
