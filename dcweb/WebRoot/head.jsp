      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="81%" align="left" valign="center" id="titleSpan" class="white3">
			...
			<table  border="0" cellpadding="0" cellspacing="0">
              <tr>
				 ...
				 <td id="mainMenu3" width="100"  class="white3" onclick="changeMenusMain('<s:property value="#session.userMenu.page"/>')" style="cursor:pointer"><strong>
				...
				<td id="mainMenu2" width="100"  class="white3" onclick="changeMenusMain('editAccountConfig.action')" style="cursor:pointer"><strong><s:text name="RES_USER"/></strong>&nbsp;</td>
              </tr>
            </table>
            </s:if>
            </td>
            ...
            <div class="divlang" style="z-index:2;">
                    <ul>
	                    ...
	                    <ul>
		                 ...
		                 <li><a href="#"><img src="images/lang/france_tp.gif" alt="French" title="French" width="118" height="22" onclick="changeLange('fr_FR')"/></a></li>
		                 <li><a href="#"><img src="images/lang/german_tp.gif" alt="German" title="German" width="118" height="22" onclick="changeLange('de_DE')"/></a></li>
 						 <li><a href="#"><img src="images/lang/italy_tp.gif" alt="Italy" title="Italy" width="118" height="22" onclick="changeLange('it_IT')"/></a></li>
		                 </ul>
