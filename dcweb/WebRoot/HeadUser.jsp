    ...
    <td height="120" align="center" background="images/top_bg.gif"><table width="960" border="0" cellspacing="0" cellpadding="0">
      <tr>
            ...
            <table  border="0" cellpadding="0" cellspacing="0">
              <tr>
               ...
               <td width="43" height="34" class="blue"><img src="images/dh_list_1_1.gif" height="30" id="mainMenuImg1"/></td>
				...
				<td id="mainMenu2" width="150" align="right" class="white3"  onclick="changeMenusMain('chartShow.action')" style="cursor:pointer"> <div align="left"><strong> 
                ...
                <td width="43" height="34" class="blue"><img src="images/dh_list_4.gif" width="43" height="30" id="mainMenuImg4"/></td>
				<td id="mainMenu2" width="150"  class="blue" align="left"><strong><s:text name="RES_USER"/></strong>&nbsp;</td>
               </s:if>
        ...
        <td width="292" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="30"  align="center" class="black2"><s:text name="RES_WELCOME"/> <span id="usernameTip"><s:property value="#session.user.firstName"/>&nbsp;<s:property value="#session.user.secondName"/></span></td>
