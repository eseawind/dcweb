      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="left" valign="center" id="titleSpan" class="white3">
			...
			<table  border="0" cellpadding="0" cellspacing="0">
              <tr>
				 ...
				 <td id="mainMenu3" width="150" align="left" class="white3" onclick="changeMenusMain('<s:property value="#session.userMenu.page"/>')" style="cursor:pointer"><strong>
                  <s:text name="RES_CONF"/></strong>
                 &nbsp;</td>
                 </s:if>
                 <s:else>
                 <td width="43" height="34" class="blue"></td>
				 <td id="mainMenu3" width="150"  class="white3" ><strong>
                  </strong>
                 &nbsp;</td>
                 </s:else>
