...
<div class="rightdh">
	<b class="dot_nav"></b><s:text name="RES_CURRENTLOCAL"/>: <a href="javascript:;" onclick="drawmenu.getBody('powerlist.action');return false;"><s:text name="RES_HOME"/></a> > <a href="javascript:;" onclick="drawmenu.getBody('reportConf.action');return false;"><s:text name="RES_CONFIG_REPORT"/></a> > <a href="javascript:;" onclick="return false;">Edit Report Configuration</a>
</div>
<div class="rightcon">
	<div class="rightcon_tcon">
		<div class="container">
			<div class="title">Edit Report Configuration ( <s:property value="#session.defaultStationMap.stationname" /> ) <input id="text_userId" type="hidden" value="<s:property value='userMap.userId'/>" /></div>
		</div>
		...
		<table id="" border="0" cellpadding="0" cellspacing="0" width="98%" style="float: left;font-weight: normal;line-height: 24px;color:#666;margin-top:15px;">
				<tr height="30px">
					...
					<td align="left" width="150px"><input class="isactiveRatio" type="radio" name="active"/>激活<input class="isactiveRatio" type="radio" name="active"/>关闭</td>
					<td>&nbsp;</td>
				</tr>
				<tr height="30px">
					<td width="30px">&nbsp;</td>
					<td align="left" width="150px"><span class="spangraytitle">收件人电子邮件地址</span></td>
					<td align="left" width="150px"><input type="email" class="input_txt"/></td>
					<td align="left">&nbsp;&nbsp;多个账户请用","号分隔</td>
				</tr>
				<tr height="30px">
					<td width="30px">&nbsp;</td>
				...
				<tr height="30px">
					...
					<td align="left"><input type="radio" name="aa"/>激活<input type="radio" name="aa"/>关闭</td>
					<td align="left">如果没有可用的新事件，是否发送报告。</td>
				</tr>
		</table>
		<table id="" border="0" cellpadding="0" cellspacing="0" width="98%" style="float: left;font-weight: normal;line-height: 24px;color:#666;margin-top:15px;">
				<tr>
					<td width="30px">&nbsp;</td>
					<td align="left" width="150px"><input class="input_btn" type="button" value="保存"/></td>
					<td align="left" width="150px">
					</td>
					<td>&nbsp;</td>
				</tr>
		...
		<table id="" border="0" cellpadding="0" cellspacing="0" width="98%" style="float: left;font-weight: normal;line-height: 24px;color:#666;margin-top:15px;">
				<tr>
					<td width="30px">&nbsp;</td>
					<td align="left" width="150px"><input class="input_btn" type="button" value="编辑"/></td>
					<td align="left" width="150px">
					</td>
					<td>&nbsp;</td>
				</tr>
